...
<head>
    ...
    <title>Koupit Vyhlídkový let balonem - starty v celé ČR ✔️ Stips.cz</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0">
    <meta name="msapplication-TileImage" content="assets/images/logos/favicon-114x114.png">
    <meta name="msapplication-TileColor" content="#b04fc1">
    <meta name="theme-color" content="#b04fc1">
    <meta name="apple-mobile-web-app-title" content="Stips.cz">
    <meta name="application-name" content="Stips.cz">
    <meta name="author" content="MSM Plus s.r.o. | Stips.cz">
    <meta name="referrer" content="always">
    <meta name="referrer" content="unsafe-url">
    <link rel="preload" href="assets/images/logos/Logo-stips-no-text-svg.svg" as="image">
    <link rel="preload" href="assets/images/empty.gif" as="image">
    <link rel="mask-icon" href="assets/images/logos/favicon-svg.svg">
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/logos/favicon-180x180.png" type="image/png">
    <link rel="apple-touch-icon" sizes="76x76" href="assets/images/logos/favicon-76x76.png" type="image/png">
    <link rel="apple-touch-icon" sizes="114x114" href="assets/images/logos/favicon-114x114.png" type="image/png">
    <link rel="apple-touch-icon" sizes="120x120" href="assets/images/logos/favicon-120x120.png" type="image/png">
    <link rel="apple-touch-icon" sizes="144x144" href="assets/images/logos/favicon-144x144.png" type="image/png">
    <link rel="apple-touch-icon" sizes="152x152" href="assets/images/logos/favicon-152x152.png" type="image/png">
    <link rel="icon" href="assets/images/logos/favicon-32x32.png" sizes="32x32" type="image/png">
    <link rel="icon" href="assets/images/logos/favicon-16x16.png" sizes="16x16" type="image/png">
    <link rel="icon" href="assets/images/logos/favicon-96x96.png" sizes="96x96" type="image/png">
    <link rel="icon" href="assets/images/logos/favicon-192x192.png" sizes="192x192" type="image/png">

    <link rel="image_src"  href="temp/Feature_1.jpg">

    <meta name="description"
          content="Vyhlídkový let balonem právem patří mezi nejoblíbenější zážitky. Rezervujte let, zažijte nezapomenutelné okamžiky až 800 metrů nad zemí. Startuje se po celé ČR!">
    <meta name="keywords" content="vyhlídkový let balonem sleva">

    <link rel="canonical" href="https://stips.cz/darek/let-balonem-letenka-pro-jednoho/">
    ...
    <noscript><img height='1' width='1' style='display: none;'
                   ...
                   alt='facebook_pixel'></noscript>
    <meta property="og:title" content="Vyhlídkový let balonem – starty po celé ČR">
    <meta property="og:type" content="article">
    <meta property="og:description"
          content="Vyhlídkový let balonem je přenádherná zkušenost. Mohly by o tom vyprávět tisíce lidí, kteří hned po svém prvním vyhlídkovém letu balonem věděli, že nepluli mezi oblaky naposledy. Tam nahoře je totiž všechno jiné. Klidnější a krásnější. Zkuste to i vy. Startujeme v celé ČR, můžete si vybrat!">
    <meta property="og:url" content="https://stips.cz/darek/let-balonem-letenka-pro-jednoho/">
    <meta property="og:site_name" content="Stips.cz">
    <meta property="og:image" content="temp/Feature_1-1024x512.jpg">


    <link rel="stylesheet" href="assets/style1.css" media="all">
    <link rel="stylesheet" href="assets/slick.css" id="slick-css"  type="text/css" media="all">
    <link rel="stylesheet" href="assets/style2.css" media="all">


    <link rel="stylesheet" href="assets/checkout.css" media="all">
    <link rel="stylesheet" href="assets/checkout2.css" media="all">
    ...
    <link rel="stylesheet" href="assets/style3.css" media="all">
