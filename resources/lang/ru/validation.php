...
return [
    ...
    */
    ...
    'future_date' => [
        'pay_greater_than' => 'Дата платежа не может быть в будущем времени.',
    ],

    'contract_start_date' => 'Дата начала программы не соответствует выбранному учебному году.',
    'contract_end_date' => 'Дата окончания программы не соответствует выбранному учебному году.',
    'comma_dot' => 'Поле не должно содеражать запятую. Десятичная часть дроби отделяется точкой.',
    'manager_commission_unique' => 'Комиссия для выбранного менеджера и выбранную дату уже существует',
